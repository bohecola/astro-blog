...
import protoSemiticB from '../../assets/images/content/proto-semitic/B.png';

![Evolution-of-B(width=400)](../../assets/images/content/english/evolution-of-b.png)

1. 古埃及象形文字𓃀，是足的象形，音：/b/，发音模拟足踏地的声音。
2. 古闪米特字母 <InlineImg src={protoSemiticB} alt={'proto-semitic-B'} />，是房屋平面图的抽象，表示“房子”，音：/bet/。
3. 腓尼基字母𐤁，继承古闪米特字母 <InlineImg src={protoSemiticB} alt={'proto-semitic-B'} /> 之音值和字义，是帐篷之形的抽象，表示“房子”，音：/beth/。
...
![ab-(width=200)](../../assets/images/content/english/ab.png)
...
![cabbage(width=200)](../../assets/images/content/english/cabbage.png)
...
![banana(width=200)](../../assets/images/content/english/banana.png)

**banana**，b“弯状”+an“一个”+an“一个”+a“一个”，“弯状的并且是一个一个的”，n.香蕉。

![beard(width=200)](../../assets/images/content/english/beard.png)
...
字母b源自古闪米特字母 <InlineImg src={protoSemiticB} alt={'proto-semitic-B'} />，是房屋平面图的象形，音：/bet/。字母b表示“房屋”。
...
### b—— <InlineImg src={protoSemiticB} alt={'proto-semitic-B'} width={'26'} height={'26'} /> 形物或概念

b- <InlineImg src={protoSemiticB} alt={'proto-semitic-B'} /> 城墙围绕的城堡。

#### 词根burg-“城堡；城镇”

词根burg-，b“ <InlineImg src={protoSemiticB} alt={'proto-semitic-B'} />”+ur通er表人+g“go”，“城墙围绕的城堡”，表示“要塞；城堡”。

![burg(width=200)](../../assets/images/content/english/burg.png)
...
词根urb-，即ur通er表人+b“ <InlineImg src={protoSemiticB} alt={'proto-semitic-B'} />”，表示“城市”，尤指“有城墙围起来的城市”，最初指罗马城。
...
![bore(width=200)](../../assets/images/content/english/旋转.png)
...
![章印(width=200)](../../assets/images/content/english/ban.png)
...
![bird(width=200)](../../assets/images/content/english/bird.png)

**bird**，b-𐤁，ir通air，bd相对，表示一对鸟翅膀，n.鸟。

### b——叶子

![bud(width=200)](../../assets/images/content/english/bud.png)
...
![孕妇身体(width=200)](../../assets/images/content/english/big.png)
...
![Bow(width=200)](../../assets/images/content/english/bow.png)
...
![bicycle(width=200)](../../assets/images/content/english/bicycle.png)
...
![bridge(width=200)](../../assets/images/content/english/bridge.png)
...
![bed(width=200)](../../assets/images/content/english/bed.png)
...
![bag(width=200)](../../assets/images/content/english/bag.png)
...
![butt(width=200)](../../assets/images/content/english/butt.png)
