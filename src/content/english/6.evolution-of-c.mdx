...
import protoSemiticC from '../../assets/images/content/proto-semitic/C.png';
import imageP from '../../assets/images/content/english/p.png';

![Evolution-of-C](../../assets/images/content/english/evolution-of-c.png)

1. 古埃及象形文字 𓎡，是弯刀的象形，音：/c/（/k/）
2. 古闪米特字母 <InlineImg src={protoSemiticC} alt={'proto-semitic-C'} />，是足的象形，音：/gimmel/，发音模拟骆驼的叫声。
3. 腓尼基字母 𐤂，继承古闪米特字母 <InlineImg src={protoSemiticC} alt={'proto-semitic-C'} /> 音值和字义，字形向上翻转，进一步苏美尔楔形化。
...
字母C古闪米特字母 <InlineImg src={protoSemiticC} alt={'proto-semitic-C'} />，是脚的象形。由“脚”的功能引申义“走”。

骆驼以适合在沙漠中长途跋涉著称，古闪米特人借用 <InlineImg src={protoSemiticC} alt={'proto-semitic-C'} />“走”之义，用来表示“路驼”，音：/gimmel/，发音源自骆驼的叫声(C、G同源)。
...
字母C源自古闪米特字母 <InlineImg src={protoSemiticC} alt={'proto-semitic-C'} />。

骆驼以适合在沙漠中长途跋涉著称，古闪米特人借用 <InlineImg src={protoSemiticC} alt={'proto-semitic-C'} /> “走”之义，用来表示“骆驼”，音：/gimmel/，发音源自骆驼的叫声(C、G同源)。
...
字母C源自腓尼基字母 𐤂，继承古闪米特字母 <InlineImg src={protoSemiticC} alt={'proto-semitic-C'} /> 音值和字义，表示“脚”。字母 𐤂 字形与角状物对应，表示“角”
...
![clav-(width=200)](../../assets/images/content/english/clav-.png)
...
![The sun is half overhead on the horizon(width=200)](../../assets/images/content/english/half-sun.png)
...
![gol-(width=200)](../../assets/images/content/english/gol-.png)
...
词根corp-，即cor“心”+p“  <InlineImg src={imageP} alt={'p'} width={'20'} height={'28'} />”，表示“躯体；团体”，词根corp-是包含心脏在内的 <InlineImg src={imageP} alt={'p'} width={'20'} height={'28'} />形躯体之形的字符化抽象表达。
